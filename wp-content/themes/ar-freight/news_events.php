				...
				<div class = "news-events-container">
                    ...
                    <div class="block-container">
                        <?php if( isset($_REQUEST['search']) && $_REQUEST['search'] != "" ):?>
                            <h2 class = "search-status">Search Result For "<?php echo $_REQUEST['search']?>"</h2>
                        <?php endif;?>  
                        <?php
...
<?php if($events->post_count == 0 && $news->post_count == 0):?>
<script>
$(document).ready(function(){
    $(".search-status").html("No Search Result Found!");
});
</script>
<?php endif;?>
